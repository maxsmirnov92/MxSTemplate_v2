...
class NotificationsAdapter(onRetryFailedClick: (NotificationsAdapterData) -> Unit): BaseDraggableDelegationAdapter<NotificationsAdapterData, BaseDraggableDelegationAdapter.DragAndDropViewHolder<NotificationsAdapterData>>(
    notificationsAdapterDelegate(onRetryFailedClick)
) {
