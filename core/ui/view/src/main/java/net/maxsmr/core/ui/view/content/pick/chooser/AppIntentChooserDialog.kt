...
import net.maxsmr.core.ui.view.content.pick.chooser.adapter.AppIntentChooserAdapter
import net.maxsmr.core.ui.view.content.pick.chooser.adapter.IntentChooserAdapterData
import net.maxsmr.core.ui.view.databinding.LayoutIntentChooserBinding
...
internal class AppIntentChooserDialog : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(net.maxsmr.core.ui.view.R.layout.layout_intent_chooser, container, false)
    }
