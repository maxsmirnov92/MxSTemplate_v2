...
import net.maxsmr.core.ui.view.databinding.ItemBottomSheetDialogAnswerBinding
import net.maxsmr.core.ui.view.databinding.LayoutBottomSheetDialogCommonWrapBinding
...
class CommonWrapBottomSheetDialog(
    ...
    private fun answerAdapterDelegate() =
        adapterDelegate<AnswerAdapterData, BaseAdapterData>(
            net.maxsmr.core.ui.view.R.layout.item_bottom_sheet_dialog_answer,
        ) {
            bind {
