...
import net.maxsmr.core.ui.view.R
...
// Файл содержит различные варианты отображения [Alert] во View.
...
fun Alert.asOkDialog(
    ...
    return DialogViewAlertRepresentation.Builder(context, this)
...
fun Alert.asMultiChoiceDialog(
    ...
    return DialogViewAlertRepresentation.Builder(context, this)
        ...
        .setMultiChoiceAnswers(
            DialogViewAlertRepresentation.Builder.MultiChoiceAnswersData(
                answers,
                if (isRadioButton) {
